...
interface LabManualsUploadData {
  department: string
  year: string
  semester: string
  subject: SubjectItem
...
interface LabManualsUploadStepProps {
  data: LabManualsUploadData
  onBack: () => void
  onReset: () => void
}
...
export function LabManualsUploadStep({ data, onBack, onReset }: LabManualsUploadStepProps) {
  ...
  const uploadFiles = async () => {
    try {
      ...
      // Create hierarchical folder: labmanuals/department/year/semester/subject_code
      const folderSafe = `labmanuals/${sanitize(data.department)}/${sanitize(data.year)}/${sanitize(data.semester)}/${sanitize(data.subject.code)}`
      ...
      // fetchLabManualFiles(data.subject.code)
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900">Upload Lab Manuals</h3>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="text-center">
          ...
          >
            ...
            <h4 className="text-lg font-medium text-gray-900 mb-2">Upload Lab Manual Files</h4>
        ...
        {allUploaded && (
          <div className="mt-6 text-center">
            <div className="mb-4">
              ...
              <p className="text-gray-600">All lab manual files have been uploaded successfully.</p>
            </div>
